...
fullyhadronicEfficiency_SingleBTag_jet = DQMEDHarvester("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLT/TopHLTOffline/TopMonitor/FullyHadronic/SingleBTag/JetMonitor/*"),
    verbose        = cms.untracked.uint32(0), # Set to 2 for all messages
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_jetPt_1       'efficiency vs 1st jet pt; jet pt [GeV]; efficiency' jetPt_1_numerator       jetPt_1_denominator",
...
fullyhadronicEfficiency_SingleBTag_bjet = DQMEDHarvester("DQMGenericClient",
    subDirs        = cms.untracked.vstring("HLT/TopHLTOffline/TopMonitor/FullyHadronic/SingleBTag/BJetMonitor/*"),
    verbose        = cms.untracked.uint32(0), # Set to 2 for all messages
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_jetPt_1       'efficiency vs 1st jet pt; jet pt [GeV]; efficiency' jetPt_1_numerator       jetPt_1_denominator",
...
topClient = cms.Sequence(
    ...
    + fullyhadronicEfficiency_DoubleBTag_all
    + fullyhadronicEfficiency_DoubleBTag_jet
    + fullyhadronicEfficiency_DoubleBTag_bjet
    + fullyhadronicEfficiency_SingleBTag_all
    + fullyhadronicEfficiency_SingleBTag_jet
    + fullyhadronicEfficiency_SingleBTag_bjet
