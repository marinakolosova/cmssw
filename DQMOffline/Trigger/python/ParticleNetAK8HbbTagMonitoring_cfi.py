...
particleNetAK8HbbTagMonitoring = _particleNetJetTagMonitor.clone(
    ## general options
    FolderName = "HLT/HIG/PNETAK8/HLT_IsoMu50_AK8PFJet220_SoftDropMass40_PFAK8ParticleNetBB0p35_or_HLT_Ele50_CaloIdVT_GsfTrkIdT_AK8PFJet220_SoftDropMass40/",
    ...
    numGenericTriggerEvent = dict(
        hltPaths      = ["HLT_IsoMu50_AK8PFJet220_SoftDropMass40_PFAK8ParticleNetBB0p35_v*",
    ...
    denGenericTriggerEvent = dict(
        hltPaths      = ["HLT_IsoMu50_AK8PFJet220_SoftDropMass40_v*",
                         "HLT_Ele50_CaloIdVT_GsfTrkIdT_AK8PFJet220_SoftDropMass40_v*",
                     ],
        andOr         = False,
        andOrHlt      = True,
        #hltInputTag   = "TriggerResults::reHLT", ## when testing in the DQM workflow (https://twiki.cern.ch/twiki/bin/viewauth/CMS/HLTValidationAndDQM)
